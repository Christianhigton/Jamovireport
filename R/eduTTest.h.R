...
eduTTestOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "eduTTestOptions",
...
eduTTestResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "eduTTestResults",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(0,1,0),
                options = options,
                results = eduTTestResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
eduTTest <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("eduTTest requires jmvcore to be installed (restart may be required)")
