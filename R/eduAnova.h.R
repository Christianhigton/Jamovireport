...
eduAnovaOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "eduAnovaOptions",
...
eduAnovaResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "eduAnovaResults",
...
eduAnova <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("eduAnova requires jmvcore to be installed (restart may be required)")
