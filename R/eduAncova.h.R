...
eduAncovaOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "eduAncovaOptions",
...
eduAncovaResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "eduAncovaResults",
...
eduAncova <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("eduAncova requires jmvcore to be installed (restart may be required)")
