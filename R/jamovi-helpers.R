...
.jr_jamovi_overview_html <- function(result) {
    .jr_html_card(
        "jamovi Report", "Guided report controls are available here",
        paste(
            "This output was generated by jamovi Report. Use the Reporting controls in this jamovi Report panel to choose style, format, tone, and included content.",
...
.jr_addon_report_html <- function(results, options = NULL, title = "Guided report", note = "") {
    ...
    if (length(results) == 0L && length(failures) > 0L) {
        ...
        return(.jr_html_card(
            ...
            paste("jamovi Report received the analysis variables but encountered a calculation problem:", message),
            accent = "#b46c21"
        ))
    }
...
.jr_addon_heading_html <- function() {
    .jr_html_card(
        "jamovi Report | Automatic report add-on", "jamovi Report output starts here",
        paste(
            "The tables and narrative below were generated by jamovi Report from the selected built-in jamovi analysis.",
            "Simplified report-style output is available only for supported analyses and will appear when those analyses are run from their respective jamovi analysis menus.",
            "Custom report style, format, tone, and included-content controls are available in the separate jamovi Report module entries; built-in analysis add-ons use a fixed APA reporting profile."
        )
    )
}
...
.jr_addon_insert_tables <- function(self, posthoc = FALSE, coefficients = FALSE, cells = FALSE,
    ...
    self$parent$results$add(jmvcore::Table$new(
        ...
        title = "APA Results Summary (jamovi Report)",
        columns = list(
    ...
    self$parent$results$add(jmvcore::Table$new(
        ...
        title = "Assumptions and Recommended Actions (jamovi Report)",
        columns = list(
            list(name = "analysis", title = "Analysis", type = "text"),
    ...
    if (isTRUE(posthoc)) {
        self$parent$results$add(jmvcore::Table$new(
            ...
            title = "APA Post Hoc Comparisons (jamovi Report)",
            visible = FALSE,
            columns = list(
                list(name = "analysis", title = "Analysis", type = "text"),
    ...
    if (isTRUE(coefficients)) {
        self$parent$results$add(jmvcore::Table$new(
            ...
            title = "Odds Ratios and Coefficients (jamovi Report)",
            visible = FALSE,
            columns = list(
    ...
    if (isTRUE(cells)) {
        self$parent$results$add(jmvcore::Table$new(
            ...
            title = "Observed and Expected Counts (jamovi Report)",
            visible = FALSE,
            columns = list(
                list(name = "analysis", title = "Analysis", type = "text"),
...
.jr_addon_insert_card <- function(self, posthoc = FALSE, coefficients = FALSE, cells = FALSE,
    ...
    heading <- jmvcore::Html$new(
        ...
        title = "jamovi Report: Automatic Reporting",
    ...
    card <- jmvcore::Html$new(
        ...
        title = "Automatic Report (jamovi Report)",
        content = .jr_html_card(
            "Automatic report", "jamovi Report",
...
.jr_addon_message <- function(self, message) {
    ...
    self$parent$results$get("jamoviReportCard")$setContent(
        .jr_html_card("Automatic report", "jamovi Report", message, accent = "#b46c21")
    )
}
