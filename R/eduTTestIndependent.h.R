...
eduTTestIndependentOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "eduTTestIndependentOptions",
...
eduTTestIndependentResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "eduTTestIndependentResults",
    ...
    public=list(
        initialize=function(options) {
            super$initialize(
                options=options,
                name="",
                title="Guided Independent Samples t-test",
                refs=list(
                    "jReport",
                    "effectsize",
                    "ggplot2",
...
eduTTestIndependentBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "eduTTestIndependentBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = eduTTestIndependentResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
#' Guided Independent Samples t-test
#'
#' Compare two independent group means while explaining assumptions, effect 
...
eduTTestIndependent <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("eduTTestIndependent requires jmvcore to be installed (restart may be required)")
    ...
    options <- eduTTestIndependentOptions$new(
        outcome = outcome,
        group = group,
        varEqual = varEqual,
        ciWidth = ciWidth,
    ...
    analysis <- eduTTestIndependentClass$new(
        options = options,
        data = data)
