...
eduRegressionOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "eduRegressionOptions",
...
eduRegressionResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "eduRegressionResults",
...
eduRegression <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("eduRegression requires jmvcore to be installed (restart may be required)")
    ...
    options <- eduRegressionOptions$new(
        outcome = outcome,
    ...
    analysis <- eduRegressionClass$new(
        options = options,
        data = data)
